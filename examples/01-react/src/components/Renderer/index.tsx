...
export const Renderer = observer((props: RendererProps) => {
  if (props.view instanceof t.TagView) {
    if (props.view.tag === 'button') {
console.log('QQQQQQQQQQ', props.view.each)
}
    if (props.view.tag === 'text') {
      // console.log('PROPS VIEW', JSON.stringify(props.view.template, null, 2))
      return <Text text={props.view.props.value} id={props.view} frame={props.view.frame} />
    }
    if (props.view.tag === 'Hero') {
      return (<main className="relative h-screen overflow-hidden bg-gray-100 dark:bg-gray-800">
